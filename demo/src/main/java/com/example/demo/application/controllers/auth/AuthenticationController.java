package com.example.demo.application.controllers.auth;

import com.example.demo.domain.requests.auth.AuthenticationRequest;
import com.example.demo.domain.responses.auth.AuthenticationResponse;
import com.example.demo.domain.services.auth.AuthenticationService;
import com.example.demo.domain.requests.auth.RegistrationRequest;
...
import com.example.demo.domain.requests.restrictions.bans.BanRequest;
...
import com.example.demo.domain.services.auth.password.PasswordValidationService;
